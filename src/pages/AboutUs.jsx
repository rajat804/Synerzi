      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center md:text-left">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About <span className="text-[#06B6D4]">SRM</span>
          </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-8">
                More About <span className="text-[#06B6D4]">SRM</span>
              </h2>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  SRM was founded with a simple idea — to bring clarity,
              ...
              {[
                {
                  ...
                  desc: "We believe in open communication and honest dealings that build long-term trust with our clients.",
                },
                {
                  title: "Customer First",
                  desc: "Every decision we make is guided by what’s best for our customers and their investments.",
                },
                {
                  title: "Innovation Driven",
                  desc: "We use modern tools and insights to deliver smarter and faster real estate solutions.",
                },
                {
                  title: "Sustainable Growth",
                  desc: "Our focus is on long-term growth that benefits clients, partners, and communities alike.",
                },
              ].map((item, i) => (
                <div
                  key={i}
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {stats.map((item, index) => (
              <div
                key={index}
                className="group relative bg-white rounded-3xl p-8 text-center border border-gray-200 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500"
              >
