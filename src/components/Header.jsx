...
const Header = () => {
  ...
  return (
    <>
      ...
      <nav className="w-full bg-[#1F2937]/95 backdrop-blur-md border-b border-[#374151] shadow-lg sticky top-0 z-50">
          ...
          <div className="flex items-center h-16 relative">
            ...
            <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center gap-8">
              {links.map((link) => {
                ...
                ${isActive ? "text-[#F59E0B]" : "text-[#E5E7EB] hover:text-[#F59E0B]"}`}
                  >
                    {link.name}

                    {/* Active underline */}
                    <span
                      className={`absolute -bottom-2 left-0 h-0.5 bg-[#F59E0B] transition-all duration-300
            ...
            <div className="hidden md:flex items-center gap-4 ml-auto">
              {/* Phone */}
              <div className="flex items-center gap-2 text-sm text-[#E5E7EB] hover:text-[#10B981] transition cursor-pointer">
                <i className="fas fa-phone-alt text-[#10B981]" />
            ...
            hover:bg-[#F59E0B] hover:text-[#1F2937]
            transition"
              >
              ...
              <Link
                to="/contact"
                className="px-4 py-2 rounded-full bg-gradient-to-r from-[#F59E0B] to-[#10B981]
            text-[#1F2937] text-sm font-semibold shadow-lg hover:scale-105 transition-transform"
              >
                Add Listing
              </Link>
            </div>
            ...
            <div className="md:hidden ml-auto">
              <button onClick={() => setIsOpen(!isOpen)}>
                <i
                  className={`fas ${isOpen ? "fa-times" : "fa-bars"} text-2xl text-[#E5E7EB]`}
                />
              </button>
            </div>
          </div>
        ...
        {/* MOBILE MENU */}
        {isOpen && (
          <div className="md:hidden bg-[#1F2937]/95 backdrop-blur-md border-t border-[#374151] px-4 py-5 space-y-3">
            {links.map((link) => {
              const isActive = location.pathname === link.path;
              return (
                <Link
              ...
              ${
                isActive
                  ...
                  : "text-[#E5E7EB] hover:bg-[#F59E0B]/10 hover:text-[#F59E0B]"
              }`}
                >
                  {link.name}
                </Link>
            ...
            {/* Mobile Phone */}
            <div className="flex items-center gap-2 text-[#E5E7EB] px-3 py-2">
              <i className="fas fa-phone-alt text-[#10B981]" />
            ...
            bg-[#374151] text-[#E5E7EB] hover:bg-[#F59E0B] hover:text-[#1F2937]"
              >
            ...
            text-[#1F2937] font-semibold shadow-lg"
              >
                Add Listing
              </Link>
            </div>
