...
const faqs = [
  {
    q: "What services does SRM provide?",
    a: "SRM offers premium real estate solutions including property investment, leasing, sales, and strategic advisory services.",
  },
  {
  ...
  {
    q: "How can I list my property with SRM?",
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-2">
            Clear answers to common questions about SRM
          </p>
        </div>
